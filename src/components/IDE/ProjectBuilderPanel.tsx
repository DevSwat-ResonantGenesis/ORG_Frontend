    ...
    <div className={styles.panel}>
      ...
      {stats && (
        <div className={styles.statsBar}>
          ...
          <div className={styles.stat}>
            <span className={styles.statValue}>{stats.storage_used_mb.toFixed(1)} MB</span>
              ...
              Array.from(activeBuilds.entries()).map(([projectId, progress]) => (
                <div key={projectId} className={styles.buildCard}>
                  ...
                  <div className={styles.buildDetails}>
                    <p className={styles.currentStep}>{progress.current_step}</p>
                    <div className={styles.buildStats}>
                      <span><FileIcon /> {progress.files_created} files</span>
