              ...
              <div ref={helpMenuRef} className={styles.helpMenuWrapper}>
                ...
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                    <text x="12" y="16" text-anchor="middle" fontSize="16" fontWeight="300">?</text>
                  </svg>
                </button>
                ...
                {showHelpMenu && (
                  <div className={styles.helpMenuDropdown}>
                    <button
                      ...
                      onClick={() => { window.location.href = 'mailto:info@dev-swat.com?subject=Support%20Request'; setShowHelpMenu(false); }}
                    >
                    ...
                    <button
                      className={styles.helpMenuItem}
                      onClick={() => { window.location.href = '/help'; setShowHelpMenu(false); }}
                    >
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    ...
                    <button
                      className={styles.helpMenuItem}
                      onClick={() => { window.location.href = 'mailto:info@dev-swat.com?subject=Sales%20Inquiry'; setShowHelpMenu(false); }}
                    >
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <>
                ...
                >
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                    <text x="12" y="17" text-anchor="middle" fontSize="18" fontWeight="300">?</text>
                  </svg>
                </a>
              </>
            )}
