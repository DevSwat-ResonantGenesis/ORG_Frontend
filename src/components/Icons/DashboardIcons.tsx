...
// Animated, minimalistic SVG icons for dashboards
...
export const FileTextIcon: React.FC<IconProps> = ({ size = 24, color = 'currentColor', className = '' }) => (
  <svg
    ...
    className={`dashboard-icon ${className}`}
  >
    <path d="M14 2H6a2 2 2 0 0 0-2 2v16a2 2 2 0 0 0 2 2h12a2 2 2 0 0 0 2-2V8z"></path>
...
export const SettingsIcon: React.FC<IconProps> = ({ size = 24, color = 'currentColor', className = '' }) => (
  ...
  >
    <circle cx="12" cy="12" r="3"></circle>
    <path d="M12 1v6m0 6v6M5.64 5.64l4.24 4.24m4.24 4.24l4.24 4.24M1 12h6m6 0h6M5.64 18.36l4.24-4.24m-4.24-4.24L1.64 5.64M18.36 18.36l-4.24-4.24m4.24-4.24L22.36 5.64"></path>
  </svg>
);
