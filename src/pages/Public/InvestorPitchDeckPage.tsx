  ...
  const panels = useMemo(
    () => [
      ...
      },
      {
        ...
        render: () => (
          <div className={styles.switchBody} role="tabpanel">
            <div className={styles.codebaseGrid}>
              <div className={styles.codebaseCard}>
                <p className={styles.codebaseKicker}>Frontend scan</p>
                <p className={styles.codebaseMetric}>
                  <span className={styles.codebaseMetricValue}>4,514</span>
                  <span className={styles.codebaseMetricLabel}>nodes mapped</span>
                </p>
                <p className={styles.codebaseDetail}>970 files (JS/TS), 2,384 functions</p>
              </div>

              <div className={styles.codebaseCard}>
                <p className={styles.codebaseKicker}>Backend scan</p>
                <p className={styles.codebaseMetric}>
                  <span className={styles.codebaseMetricValue}>29,877</span>
                  <span className={styles.codebaseMetricLabel}>nodes mapped</span>
                </p>
                <p className={styles.codebaseDetail}>
                  1,696 files, 17,613 functions, 6,166 classes
                </p>
              </div>

              <div className={styles.codebaseCard}>
                <p className={styles.codebaseKicker}>Surface area</p>
                <p className={styles.codebaseMetric}>
                  <span className={styles.codebaseMetricValue}>4,338</span>
                  <span className={styles.codebaseMetricLabel}>API endpoints</span>
                </p>
                <p className={styles.codebaseDetail}>Gateway + service mesh endpoints enumerated</p>
              </div>
            </div>

            <p className={styles.switchText}>
              These numbers are generated by an automated architecture map (Code Visualizer) running against production repos.
            </p>
          </div>
        )
      }
