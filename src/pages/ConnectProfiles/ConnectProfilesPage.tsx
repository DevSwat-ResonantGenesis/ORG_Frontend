...
const INTEGRATIONS: Integration[] = [
  ...
  { id: 'bitbucket', name: 'Bitbucket', description: 'Sync projects to Bitbucket repositories.', emoji: '🪣', icon: '/images/connect-icons/bitbucket.png', logoColor: '#0052CC', category: 'Version Control', authType: 'coming_soon', status: 'coming_soon' },
  ...
  { id: 'local-llm', name: 'Local LLM', description: 'Connect your own local LLM (Ollama, LM Studio, llama.cpp) running on your device.', emoji: '💻', logoColor: '#22d3ee', category: 'AI & Intelligence', authType: 'coming_soon', status: 'coming_soon' },
  { id: 'digitalocean', name: 'DigitalOcean', description: 'Deploy projects to DigitalOcean Droplets, App Platform, or Kubernetes.', emoji: '🌊', icon: '/images/connect-icons/digitalocean.png', logoColor: '#0080FF', category: 'Cloud & Hosting', authType: 'coming_soon', status: 'coming_soon' },
  { id: 'vercel', name: 'Vercel', description: 'One-click deploy React/Next.js projects to the Vercel edge network.', emoji: '▲', icon: '/images/connect-icons/vercel.svg', logoColor: '#ffffff', category: 'Cloud & Hosting', authType: 'coming_soon', status: 'coming_soon' },
  { id: 'netlify', name: 'Netlify', description: 'Deploy static sites and serverless functions to Netlify CDN.', emoji: '🌐', icon: '/images/connect-icons/netlify.png', logoColor: '#00C7B7', category: 'Cloud & Hosting', authType: 'coming_soon', status: 'coming_soon' },
  { id: 'railway', name: 'Railway', description: 'Deploy any backend project to Railway with automatic scaling.', emoji: '🚂', icon: '/images/connect-icons/railway.png', logoColor: '#7A3FDE', category: 'Cloud & Hosting', authType: 'coming_soon', status: 'coming_soon' },
  ...
  { id: 'supabase', name: 'Supabase', description: 'Auto-provision databases, auth and storage for generated backends.', emoji: '⚡', icon: '/images/connect-icons/supabase.png', logoColor: '#3ECF8E', category: 'Databases', authType: 'coming_soon', status: 'coming_soon' },
  { id: 'mongodb', name: 'MongoDB Atlas', description: 'Auto-create Atlas databases for generated projects.', emoji: '🍃', icon: '/images/connect-icons/mongodb.png', logoColor: '#13AA52', category: 'Databases', authType: 'coming_soon', status: 'coming_soon' },
  ...
  { id: 'stripe', name: 'Stripe', description: 'Auto-configure Stripe checkout and subscriptions in e-commerce projects.', emoji: '💳', icon: '/images/connect-icons/stripe.png', logoColor: '#6772E5', category: 'Payments', authType: 'coming_soon', status: 'coming_soon' },
  { id: 'twilio', name: 'Twilio', description: 'Add SMS and messaging to your generated applications.', emoji: '📱', icon: '/images/connect-icons/twilio.png', logoColor: '#F22F46', category: 'Communication', authType: 'coming_soon', status: 'coming_soon' },
  { id: 'sendgrid', name: 'SendGrid', description: 'Configure transactional email in generated apps.', emoji: '📧', icon: '/images/connect-icons/sendgrid.png', logoColor: '#1A82E2', category: 'Communication', authType: 'coming_soon', status: 'coming_soon' },
  { id: 'zapier', name: 'Zapier', description: 'Trigger Zapier workflows on build completion and project events.', emoji: '⚡', icon: '/images/connect-icons/zapier.png', logoColor: '#FF4A00', category: 'Automation', authType: 'coming_soon', status: 'coming_soon' },
  { id: 'n8n', name: 'n8n', description: 'Open-source workflow automation for advanced build pipelines.', emoji: '🔄', icon: '/images/connect-icons/n8n.png', logoColor: '#EA4B71', category: 'Automation', authType: 'coming_soon', status: 'coming_soon' },
  { id: 'sentry', name: 'Sentry', description: 'Auto-configure error tracking in your generated applications.', emoji: '🛡️', icon: '/images/connect-icons/sentry.png', logoColor: '#362D59', category: 'Monitoring', authType: 'coming_soon', status: 'coming_soon' },
  { id: 'datadog', name: 'Datadog', description: 'Monitor deployed applications with APM, logs, and metrics.', emoji: '📊', icon: '/images/connect-icons/datadog.png', logoColor: '#632CA6', category: 'Monitoring', authType: 'coming_soon', status: 'coming_soon' },
