        ...
        <section ref={heroRef} className={styles.hero}>
            ...
            <div className={styles.heroBottomBar}>
                ...
                <div className={styles.heroBottomSocial}>
                    ...
                    <a href="https://reddit.com/r/ResonantGenesis" target="_blank" rel="noopener noreferrer" title="Reddit" style={{ color: iconColor, transition: 'color 0.2s' }} onMouseEnter={e => (e.currentTarget.style.color = iconHover)} onMouseLeave={e => (e.currentTarget.style.color = iconColor)}>
                ...
                <div className={styles.heroBottomLinks}>
                    ...
                    <span style={{ color: textColor }}>© 2026 DevSwat Inc. · San Francisco, CA · info@dev-swat.com</span>
                </div>
            </div>
        </section>
    );
