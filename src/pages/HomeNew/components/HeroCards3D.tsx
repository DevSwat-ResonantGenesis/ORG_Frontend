...
const CARDS: Card3D[] = [
    ...
    { label: "API's",      desc: '',            color: '#FFFFFF', textColor: '#121214', route: '/api/docs',              px: 4.2,  w: 1.5, h: 1.8, chaosX: 1.6,  delay: 1.5 },
    { label: 'Memory',     desc: 'Knowledge',   color: '#71C23E', textColor: '#121214', route: '/products/memory',       px: 3.7,  w: 3.2, h: 2.0, chaosX: 0.8,  delay: 1.8 },
];
