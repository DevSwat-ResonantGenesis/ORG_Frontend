...
const CARDS: Card3D[] = [
    ...
    { label: 'Code',       desc: 'AI dev',      color: '#121214', textColor: '#ffffff', route: '/products/ide',           px: 0.2,  w: 3.8, h: 2.2, chaosX: 1.8,  delay: 0.85 },
    ...
    { label: 'Agents',     desc: 'Workflows',   color: '#01A6BC', textColor: '#ffffff', route: '/products/ai-agents',     px: 0.5,  w: 2.6, h: 2.1, chaosX: 1.4,  delay: 0.85 },
