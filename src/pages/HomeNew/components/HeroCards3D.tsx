...
const CARDS: Card3D[] = [
    ...
    { label: 'Governance', desc: 'Compliance',  color: '#FFD800', textColor: '#121214', route: '/products/governance',    px: 4.0,  w: 2.5, h: 5.5, chaosX: 2.0,  delay: 1.4, vertical: true },
    ...
    { label: 'Tools',      desc: '',            color: '#FA547C', textColor: '#ffffff', route: '/products/neural-routing',px: 4.3,  w: 2.4, h: 2.6, chaosX: 1.0,  delay: 0.8 },
    { label: "API's",      desc: '',            color: '#FFFFFF', textColor: '#121214', route: '/api/docs',              px: 4.2,  w: 1.5, h: 1.8, chaosX: 1.6,  delay: 1.0 },
...
export function HeroCards3DScene() {
    ...
    return (
        ...
        >
            ...
            <ContactShadows position={[0, floorY + 0.02, 0]} opacity={1.0} scale={30} blur={1.0} far={10} frames={1} color="#000000" />
        </Canvas>
    );
}
