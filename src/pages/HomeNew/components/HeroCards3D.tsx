...
const CARDS: Card3D[] = [
    ...
    /* Top center: wide code card              x[-1.0, 2.5]   y[1.8, 3.8]  */
    { label: 'Code',       desc: 'AI-powered dev',      color: '#121214', textColor: '#ffffff', px: 0.75, py: 2.8,  pz: -0.3, w: 3.5, h: 2.0, chaosX: -1.8, chaosRx: 0.8,  chaosRy: -0.6, chaosRz: 0.35, delay: 0.0 },
    /* Right pillar: TALL yellow               x[2.75, 5.25]  y[-1.75, 3.25] */
    { label: '',           desc: '',                     color: '#FFD800', textColor: '#121214', px: 4.0,  py: 0.75, pz: 0.4,  w: 2.5, h: 5.0, chaosX: 2.0,  chaosRx: -0.7, chaosRy: 0.8,  chaosRz: -0.3, delay: 0.18 },
    /* Left: orange square                     x[-3.75, -1.25] y[0.25, 2.75] */
    { label: '',           desc: '',                     color: '#FAA525', textColor: '#121214', px: -2.5, py: 1.5,  pz: 0.2,  w: 2.5, h: 2.5, chaosX: -1.2, chaosRx: 0.9,  chaosRy: -0.4, chaosRz: 0.2,  delay: 0.35 },
    ...
    /* Bottom right: memory                    x[2.45, 3.95]   y[-4.0, -2.0] */
    { label: 'Memory',     desc: 'Persistent knowledge', color: '#FFFFFF', textColor: '#121214', px: 3.2,  py: -3.0, pz: -0.5, w: 1.5, h: 2.0, chaosX: 1.6,  chaosRx: -0.8, chaosRy: 0.5,  chaosRz: -0.3, delay: 0.22 },
