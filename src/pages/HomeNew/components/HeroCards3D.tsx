...
const CARDS: Card3D[] = [
    ...
    { label: 'Governance', desc: 'Compliance',  color: '#FFD800', textColor: '#121214', route: '/products/governance',    px: 4.0,  w: 2.5, h: 5.5, chaosX: 2.0,  delay: 0.8, vertical: true },
    ...
    { label: 'Memory',     desc: 'Knowledge',   color: '#71C23E', textColor: '#121214', route: '/products/memory',       px: 3.7,  w: 3.2, h: 2.0, chaosX: 0.8,  delay: 1.4 },
];
