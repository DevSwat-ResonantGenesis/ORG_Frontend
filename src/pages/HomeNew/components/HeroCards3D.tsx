...
const CARDS: Card3D[] = [
    ...
    { label: "LLM's",      desc: '',            color: '#FAA525', textColor: '#121214', route: '/products/chat',          px: 4.5,  w: 2.0, h: 2.0, chaosX: 1.2,  delay: 0.3 },
    { label: 'Agents',     desc: 'Workflows',   color: '#01A6BC', textColor: '#ffffff', route: '/products/ai-agents',     px: 3.8,  w: 2.6, h: 2.1, chaosX: 1.4,  delay: 0.15 },
    { label: 'Tools',      desc: '',            color: '#FA547C', textColor: '#ffffff', route: '/products/neural-routing',px: 4.3,  w: 2.4, h: 2.6, chaosX: 1.0,  delay: 0.7 },
    { label: "API's",      desc: '',            color: '#FFFFFF', textColor: '#121214', route: '/api/docs',              px: 4.2,  w: 1.5, h: 1.8, chaosX: 1.6,  delay: 0.9 },
    { label: 'Memory',     desc: 'Knowledge',   color: '#71C23E', textColor: '#121214', route: '/products/memory',       px: 3.7,  w: 3.2, h: 2.0, chaosX: 0.8,  delay: 0.5 },
];
