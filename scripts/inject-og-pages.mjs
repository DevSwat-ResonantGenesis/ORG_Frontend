...
const OG_PAGES = [
  {
    ...
    description: 'Free tier to get started, Plus for power users, Enterprise for teams. Build, run, and schedule AI agents. DevSwat IDE, Code Visualizer, OpenClaw — all included.',
  ...
  },
  {
    ...
    description: 'Create your free DevSwat account. Build and run AI agents, use the DevSwat IDE, and scan code with Code Visualizer.',
    image: 'https://dev-swat.com/devswat/DevSwat.png',
  ...
  },
  {
    ...
    description: 'Log in to DevSwat. Access your agents, IDE projects, and Code Visualizer scans.',
    image: 'https://dev-swat.com/devswat/DevSwat.png',
  ...
  },
  {
    ...
    description: 'Complete API reference for DevSwat: authentication, agents, IDE, billing, memory, code analysis, and all platform endpoints.',
    image: 'https://dev-swat.com/devswat/DevSwat.png',
  ...
  },
  {
    ...
    description: 'Documentation, guides, and FAQs for DevSwat: getting started, agent building, IDE setup, Code Visualizer, memory systems, and API reference.',
    image: 'https://dev-swat.com/devswat/DevSwat.png',
  ...
  },
  {
    ...
    description: 'Full-stack agentic AI platform built from scratch by Louie Nemesh. 7 proprietary IP systems, ~550K lines of code. AI agents, IDE, governance, smart routing. Production-deployed at dev-swat.com.',
    image: 'https://dev-swat.com/devswat/DevSwat.png',
    url: 'https://dev-swat.com/about',
  },
  {
    route: '/technology',
    title: 'Technology — DevSwat Architecture, Agent Runtime, AI Infrastructure',
    description: 'Full-stack AI infrastructure: RARA governance, 137-tool federated agent runtime, personalized chat intelligence, smart routing, and semantic memory.',
    image: 'https://dev-swat.com/devswat/DevSwat.png',
    url: 'https://dev-swat.com/technology',
  },
  {
    route: '/open-source',
    title: 'Open Source — DevSwat GitHub Repos, OpenClaw',
    description: 'DevSwat open-source repositories on GitHub, including OpenClaw, the local-first federated agent connector. Auditable, source-available code.',
    image: 'https://dev-swat.com/devswat/DevSwat.png',
  ...
  },
  {
    ...
    description: 'Join DevSwat. Work on AI agent infrastructure and a full AI IDE. Python, FastAPI, React, Docker.',
    image: 'https://dev-swat.com/devswat/DevSwat.png',
  ...
  },
  {
    ...
    description: 'AST/SAST scanning, RARA governance, immutable audit trails, EU AI Act/SOC2 compliance profiles.',
    image: 'https://dev-swat.com/devswat/DevSwat.png',
  ...
  },
  {
    ...
    description: 'Feature comparison: agents, SAST, memory vs AI autocomplete.',
    image: 'https://dev-swat.com/devswat/DevSwat.png',
  ...
  },
  {
    ...
    description: 'Both have agentic coding. DevSwat adds a full agent platform, SAST, and governance.',
    image: 'https://dev-swat.com/devswat/DevSwat.png',
  ...
  },
  {
    ...
    description: 'Chat assistant vs full agentic infrastructure: agents, IDE, SAST, governance.',
    image: 'https://dev-swat.com/devswat/DevSwat.png',
  ...
  },
  {
    ...
    description: 'Cloud IDE vs full AI infrastructure: agents, SAST, governance.',
    image: 'https://dev-swat.com/devswat/DevSwat.png',
  ...
  // Batch 4: Docs
  {
    ...
    description: 'Full-stack AI agent infrastructure. Governance, smart routing, memory, IDE. Technical deep dive.',
    image: 'https://dev-swat.com/devswat/DevSwat.png',
  ...
  },
  {
    ...
    description: 'Deep dives into agentic AI, neural routing, governance, and platform architecture.',
    image: 'https://dev-swat.com/devswat/DevSwat.png',
  ...
  },
  {
    ...
    description: 'JWT/MFA auth, AES encryption, tamper-evident audit trails, RARA governance, compliance.',
    image: 'https://dev-swat.com/devswat/DevSwat.png',
  ...
  {
    route: '/community',
    title: 'Community — Open Source & Developers | DevSwat',
    description: 'Open source, developer forums, contributor opportunities.',
    image: 'https://dev-swat.com/devswat/DevSwat.png',
