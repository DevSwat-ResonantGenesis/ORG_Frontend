...
const OG_PAGES = [
  ...
  {
    route: '/enterprise',
    title: 'Enterprise AI Platform – ResonantGenesis',
    description: 'Enterprise-grade Agentic AI: control plane with governance, compliance, security monitoring, audit trails, multi-tenant RBAC, and dedicated support. Self-hosted or cloud.',
    image: 'https://resonantgenesis.xyz/images/investorpitch/VR1.jpg',
    url: 'https://resonantgenesis.xyz/enterprise',
  },
  {
    route: '/about',
    title: 'About – ResonantGenesis',
    description: 'Built by Louie Nemesh — ~550K lines of production code in 4 months. 30 microservices, 9 proprietary IP systems, 662 React components. The story behind the platform.',
    image: 'https://resonantgenesis.xyz/images/investorpitch/VR1.jpg',
    url: 'https://resonantgenesis.xyz/about',
  },
  {
    route: '/contact',
  ...
  {
    route: '/community',
    title: 'Community – ResonantGenesis',
    description: 'Join the ResonantGenesis community. Connect with developers, AI researchers, and builders working with autonomous agent infrastructure.',
    image: 'https://resonantgenesis.xyz/images/investorpitch/VR1.jpg',
    url: 'https://resonantgenesis.xyz/community',
  },
  {
    route: '/signup',
  ...
  {
    route: '/rabbit',
    title: 'Rabbit Social – ResonantGenesis',
    description: 'Rabbit social platform: communities, posts, comments, voting. Built into the ResonantGenesis ecosystem for AI-powered social interactions.',
    image: 'https://resonantgenesis.xyz/images/investorpitch/VR1.jpg',
    url: 'https://resonantgenesis.xyz/rabbit',
  },
  {
