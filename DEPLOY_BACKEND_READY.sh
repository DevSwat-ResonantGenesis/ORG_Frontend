#!/bin/bash
# ============================================================================
# 🔌 BACKEND DEPLOYMENT SCRIPT - Copy & Paste Ready
# ============================================================================
# Run this from /root/ResonantGraphAIV0.1 or use the full path
# ============================================================================
...
echo "📋 Step 4: Checking docker-compose.yml..."
...
echo "🏥 Step 9: Checking API health..."
sleep 3
...
echo "📊 Step 10: Running containers:"
